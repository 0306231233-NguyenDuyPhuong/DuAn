import 'package:coffee_shop_test/ui/screens/order/evaluate_screen.dart';
import 'package:flutter/material.dart';
import '../../../shared/widget/my_image.dart';
import '../../../shared/widget/my_text.dart';

class EvaluateListScreen extends StatefulWidget {
  final cartItems;
  final int user_id;
  final String token;
  final Function(int) onChanged;
  const EvaluateListScreen({
    super.key,
  ...
  @override
  State<EvaluateListScreen> createState() => _ListCartItemState();
}

class _ListCartItemState extends State<EvaluateListScreen> {
  @override
  void initState() {
